...
@interface UIControl (TKBlockButton)
 ...
 */
- (void)controlEvents:(UIControlEvents)controlEvents handle:(nullable void(^)(__kindof UIControl *)) eventHandleBlock;


@end


@interface UIGestureRecognizer (TKBlockRecognizer)
...
@interface UIView (TKBlockRecognizer)
